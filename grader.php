...
<div class="col-md-6">
  <form id="grade_form" name="grade_form" action="" method="get">
    <div class="form-group row">
      ...
      <div class="col-sm-9">
        <input class="form-control" type="text" placeholder="<?php print $course->getCourseNumber(); ?>" id="cseLogin" readonly/>
      </div>
    </div>
    <div class="form-group row">
      <label for="cse_password" class="col-sm-3 col-form-label">Password</label>
      <div class="col-sm-9">
        <input class="form-control" type="password" name="cse_password" id="cse_password"/>
      </div>
    </div>
    <div class="form-group row">
